...
const ETUAdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-100 p-6">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-6 animate-bounce">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-3 space-y-6">
          ...
          {animatedDoctors.map((doc) => (
            <div
              key={doc.id}
              className="bg-white rounded-xl shadow-md p-4 flex justify-between items-center hover:scale-105 hover:shadow-xl transition-transform"
            >
              <div>
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`w-12 h-12 rounded-full ${getStatusColor(doc.status)} relative flex items-center justify-center animate-pulse`}
                >
                ...
                <div className="w-24 mt-2 bg-gray-200 h-3 rounded">
                  <div
                    ...
                    style={{ width: `${doc.animatedAvailability}%` }}
                  ></div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 ml-4">
                ...
                <button className="px-3 py-1 bg-yellow-400 text-white rounded hover:bg-yellow-500 transition-colors text-sm">
                  ⚡ Assign
                </button>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <button className="w-full mb-2 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors animate-pulse">
              ➕ Add Doctor
            </button>
            <button className="w-full py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors animate-pulse">
              🛑 Remove Doctor
            </button>
          </div>
